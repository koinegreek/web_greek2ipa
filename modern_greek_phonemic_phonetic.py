...
def main(words):
    ...
    phonemic = "/"+transcribed_phonemic(transcribed_case_and_stress(words_split))+"/"
    phonetic = "["+remove_acute(convert_stress(transcribed_phonetic(transcribed_case_and_stress(words_split))))+"]"
